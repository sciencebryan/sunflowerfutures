...
const FV={
  ...
  catalpas:["The catalpas came into leaf all at once, and the building went cool.",
            "Catalpa flowers all over the ground by the door, and the long seed pods rattling overhead.",
            "Somebody sat out the worst of the afternoon under the catalpas and got a whole hour's work done there."],
  woodlot:["The woodlot stools are throwing up new shoots already. Cut, and it grows back, and you cut it again.",
           "Whoever kept this woodlot kept it for a hundred years. We're just the next ones cutting it."],
  beaver:["The beaver ponds are stepping the creek down slow. The low ground stays wet all week now.",
          "A beaver was working the lower dam at dusk, entirely unbothered by being watched."],
  landfill:["The green hill is only a hill from a distance. Dig anywhere and it's someone's whole life down there.",
            "Something rusted came up through the grass on the mound again."],
  chestnuts:["The chestnuts are still standing, which almost nothing is.",
